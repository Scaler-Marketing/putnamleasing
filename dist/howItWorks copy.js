...
})({"lPVFz":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f65fe3734824706c";
"use strict";
...
},{}],"lIMsq":[function(require,module,exports,__globalThis) {
function setHowItWorksSections() {
    ...
    mm.add({
        ...
        if (ctx.conditions.small) initializeSections(".image-mask_mobile", true);
    ...
    function initializeSections(maskSelector, isMobile) {
        ...
        if (!howItWorksSections || !howItWorksMasks) return;
            ...
            if (isMobile) {
                ...
                const sectionTl = gsap.timeline({
                    scrollTrigger: {
                        ...
                        onEnterBack: ()=>{
                            if (!isLast) maskTl.progress(1).reverse();
                        },
                        onLeave: ()=>{
                            if (!isLast) maskTl.seek("out").play();
                        },
                        onLeaveBack: ()=>{
                            if (!isFirst) maskTl.seek("out").reverse();
                        }
                    }
                });
            }
...
},{}]},["lPVFz","lIMsq"], "lIMsq", "parcelRequire94c2")

//# sourceMappingURL=howItWorks copy.js.map
